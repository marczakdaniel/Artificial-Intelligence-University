...
all_card_points = ['2', '3', '4', '5', '6', '7', '8', '9', '10', 'WALET', 'DAMA', 'KROL', 'AS']
all_card_signs = ['PIK', 'KIER', 'TREFL', 'KARO']
card_points_B = ['2', '3', '4', '5', '6', '7', '8', '9', '10']
card_points_F = ['AS', 'KROL', 'DAMA', 'WALET']
zbior_F = []
zbior_B = []
zbior_C = []
...
print(prawdopodobienstwo(10000, zbior_F, zbior_B))
#print(najlepsza_talia(11))
